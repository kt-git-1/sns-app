...
public enum DomainError {
    ...
    // タイムライン
    TIMELINE_INVALID_CURSOR_FORMAT("TIMELINE_INVALID_CURSOR_FORMAT", HttpStatus.UNPROCESSABLE_ENTITY),
    TIMELINE_INVALID_CURSOR_VALUE("TIMELINE_INVALID_CURSOR_VALUE", HttpStatus.UNPROCESSABLE_ENTITY);
